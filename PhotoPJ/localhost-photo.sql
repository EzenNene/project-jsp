...
INSERT INTO RESERV VALUES (r_id_seq.nextval, '김모델', '카페컨셉', 1);
INSERT INTO RESERV VALUES (r_id_seq.nextval, '이모델', '야외컨셉', 2);
INSERT INTO RESERV VALUES (r_id_seq.nextval, '강모델', '일상컨셉', 3);
INSERT INTO RESERV VALUES (r_id_seq.nextval, '최모델', '웨딩컨셉', 4);
INSERT INTO RESERV VALUES (r_id_seq.nextval, '박모델', '유아컨셉', 1);
INSERT INTO RESERV VALUES (r_id_seq.nextval, '오모델','스트릿컨셉', 2);
...
insert into testdate values(d_id_seq.nextval,'1월 9일','1');
...
on m2.p_id = m1.p_id and m2.p_name = '홍길동'
...
on m2.p_id = m1.p_id and m2.p_name = '홍길동' order by reserv_id;
